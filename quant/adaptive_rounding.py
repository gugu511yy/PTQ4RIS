...
from .quant_layer import UniformAffineWeightQuantizer, round_ste
class AdaRoundQuantizer(nn.Module):
    ...
    def __init__(self, uaq: UniformAffineWeightQuantizer, weight_tensor: torch.Tensor, round_mode='learned_round_sigmoid'):
