from quant_layers.conv import MinMaxQuantConv2d,PTQSLQuantConv2d, BatchingEasyQuantConv2d
from quant_layers.linear import MinMaxQuantLinear,PTQSLBatchingQuantLinear, PostGeluPTQSLBatchingQuantLinear
from quant_layers.matmul import PTQSLBatchingQuantMatMul, SoSPTQSLBatchingQuantMatMul,MinMaxQuantMatMul
...
def get_module(module_type, *args, **kwargs):
    if module_type == "qconv":
        ...
        module=BatchingEasyQuantConv2d(*args,**kwargs,w_bit=w_bit["qconv"],a_bit=32)
